...
Address.destroy_all
Address.create([
    { user_id: 1, street: "734 Quebec Place NW", city: "Washinton", state: "DC", zip: "20010" },
    { user_id: 2, street: "1600 Pennsylvania Ave NW", city: "Washinton", state: "DC", zip: "20009" },
    { user_id: 3, street: "1400 U St NW", city: "Washinton", state: "DC", zip: "20016" }
])
